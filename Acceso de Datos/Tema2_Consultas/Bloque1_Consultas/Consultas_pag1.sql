...
-- Πedad (σnomequipo='Artiach' or nomequipo='Amore Vita')(ciclista)
SELECT DISTINCT edad FROM ciclista
...
-- Πdorsal (σedad<25 or edad>30) (ciclista)
...
-- Πdorsal (σedad>=28 and edad<=32 and nomequipo='Banesto') (ciclista)
SELECT DISTINCT dorsal FROM ciclista
