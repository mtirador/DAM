...
public class Facturas {
	...
	public Facturas() {
		...
		this.nomCliente = " ";
		this.importe = 0.0f;
		this.fechaF = null; // o localdate now
	}
	...
	public void setImporte(float importe) throws Exception {
		...
		if(importe <=0) {
			throw new Exception("Importe no valido");	
		}
	...
	public String toString() {
		return "Facturas [numFactura=" + numFactura + ", nomCliente=" + nomCliente + ", importe=" + importe
				+ ", fechaF=" + fechaF + "fecha de Cobro"+ fechaCobro();
	}
